...
public class FrmDirectorio extends javax.swing.JFrame {
    ...
    public FrmDirectorio() {
        ...
        //La siguiente linea es para que los elementos de modeloList1
        //se pase a jlInicial
        jlInicial.setModel(modeloList1);
        jlFinal.setModel(modeloList2);
        dir=new DirectorioV1();
        
        //Se seleccion el boton nombre como predeterminado
        //Osea que el boton nombre aparece marcado automaticamente
        rbNombre.setSelected(true);
        
        //Hace que se enfoque txtNombre
    ...
    private void Registrar(){
        //Se obtiene el contenido de txtNoombre y se almacena en nombre;
        String nombre=txtNombre.getText();
        //Se obtiene el valor de ingresado en txtEdad y se convierte en entero
        //y se almacena en edad
        int edad=Integer.parseInt(txtEdad.getText());
        if(edad<14 || edad>99)
        {
            //Hace que aparezaca un cuadro de Dialogo(Ventana Emergente)
            //El cuadro de diálogo muestra un mensaje de error con el texto 
            //"Ingrese Edad mayor a 14 años", un título "ERROR" y un ícono 
            //de advertencia ( JOptionPane.WARNING_MESSAGE).
            JOptionPane.showMessageDialog(this, "Ingrese Edad mayor a 14 años","ERROR", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        
        //Entonces, en resumen, la línea de código toma el objeto seleccionado en un JComboBox llamado "cbGenero" (que se espera sea una cadena) y lo almacena en la variable "genero" 
        //como una cadena de texto (String). Esto te permite trabajar con el valor seleccionado como una cadena en tu programa Java.
    ...
    private void txtNombreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyPressed
        ...
        //KeyEvent.VK_ENTERes una constante que representa el código de la tecla 
        //"Enter" en el teclado
        // El método getKeyCode()devuelve KeyEventel código de la tecla que fue presionada.
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        ...
        //Se verifica si un botón de radio llamado rbNombreestá seleccionado. Si este botón está seleccionado, 
        //significa que el usuario ha elegido ordenar por nombre.
        if (rbNombre.isSelected())
            //Si el botón de radio rbNombreestá seleccionado, se llama a un método sort()en el objeto dir
            sortedList=dir.sort(Persona.NAME,(String)cbAlgoritmo.getSelectedItem());
        else
            
            
            //Si el botón de radio rbNombre no está seleccionado (lo que significa que el usuario ha elegido ordenar por edad),
            //se ejecutará el bloque else. En este caso, se llama al método sort()nuevamente en el objeto dir, pero con el 
            //atributo Persona.AGEcomo criterio de clasificación en lugar de Persona.NAME.
            sortedList=dir.sort(Persona.AGE,(String)cbAlgoritmo.getSelectedItem());
        
        //Después de obtener la lista ordenada, se llama al método removeAllElements()en un modelo de 
        //lista llamado modeloList2. Esto elimina todos los elementos del modelo de lista modeloList2
        modeloList2.removeAllElements();
        
        //
        for(Persona p: sortedList)
            
            //se llama al método addElement()en un modelo de lista llamado modeloList2. 
            //Este método se utiliza para agregar un elemento al modelo de lista
    ...
    private void rbNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbNombreActionPerformed
        ...
        //setSelected(false): Este métodorbEdady se utiliza para establecer el estado 
        //de selección del botón de radio. Al pasar falsecomo argumento, se indica que el botón de radio debe estar desmarcado.
